...
CREATE TABLE gambit.positions (
    ...
    ply       int NOT NULL,
    position  chess_position NOT NULL,
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXECUTE format(
            'CREATE INDEX %I ON gambit.%I (position)',
...
CREATE INDEX positions_default_position_idx ON gambit.positions_default (position);
